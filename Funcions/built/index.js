...
function execucions() {
    ...
    const paraules = ["blau", "vermell", "taronja", "gris", "platejat"]; //Resultat: 3 elements: vermell, taronja, platejat
...
function enviarMissatges(paraula, paraula2) {
}
function analitzarTemperatures(...temperatura) {
    let maxTemp = Math.max(...temperatura);
    let minTemp = Math.min(...temperatura);
    console.log(maxTemp);
    console.log(minTemp);
